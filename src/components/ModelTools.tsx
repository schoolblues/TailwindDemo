                ...
                <div className="overflow-hidden">
                    <div className="">
                        ...
                        <div className="flex mt-5 mb-4">
                            ...
                            <div className="mt-1 mr-5 ml-auto">
                                <img className="h-3.5 w-4" src={dotMenu} alt="" />
                            </div>
                        </div>
                        <div className="w-auto mr-5 border-t border-solid border-windows-100"></div>
                        <div className="mt-5 mb-3 flex text-center items-center">
