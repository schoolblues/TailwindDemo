    ...
    return (
        <div className="flex h-full w-60 border-solid rounded-tr-2xl border-windows-300 bg-white">
            <div className="flex flex-col w-full leading-none">
                ...
                <div className="flex items-center indent-3 pt-2 pb-2 my-2 mx-2 text-black/60 my-2 mx-2">
                ...
                <div className="flex items-center indent-3 pt-2 pb-2 my-2 mx-2 text-black/60 my-2 mx-2">
                    <img className="h-4 w-4 ml-2" src={memory} alt="img" />
                    <p>Memory</p>
                </div>
                <div className="flex items-center indent-3 pt-2 pb-2 my-2 mx-2 text-black/60 my-2 mx-2">
                ...
                <div className="flex items-center indent-3 pt-2 pb-2 my-2 mx-2 text-black/60 my-2 mx-2">
                    <img className="h-4 w-4 ml-2" src={scale} alt="img" />
                    <p>Evaluations</p>
                </div>
                <div className="flex items-center indent-3 pt-2 pb-2 my-2 mx-2 text-black/60 my-2 mx-2">
                    <img className="h-4 w-4 ml-2" src={shield} alt="img" />
                    <p>Guardrails</p>
                </div>
            </div>
        </div>
